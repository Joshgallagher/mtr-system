...
/**
 * This class models a rail line from the MTR System. To mimic a line,
 * this class makes use of an <code>ArrayList</code> made up of <code>Station</code>'s.
 * 
...
public class Line {
    ...
    /**
     * Adds a station to a line. If the <code>Line</code> was successfully
     * added, then this method would return true, however, if it was not
     * added it would return false.
     * 
     * @param station The <code>Station</code> object to be added to a line.
     */
     ...
     * 
     * @return stationsInLine Returns an <code>ArrayList</code> of <code>Station</code>'s.
     */
    ...
    /**
     * Returns the <code>Line</code> objects information.
     * The <code>toString</code> method only returns a lines
     * name when called.
     * 
     * @return string The lines name is returned when called on a <code>Line</code> object.
     */
